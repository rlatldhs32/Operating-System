...
void add_proc_list(char path[PATH_LEN], bool isMypS, bool aOption, bool uOption, bool xOption, unsigned long cpuTimeTable[]);

//	/proc 디렉터리 탐색하는 함수
void search_proc(bool isMyps, bool aOption, bool uOption, bool xOption, unsigned long cpuTimeTable[]);
